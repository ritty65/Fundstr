...
export const NUTZAP_WS_TIMEOUT_MS = Number(
  import.meta.env.VITE_NUTZAP_WS_TIMEOUT_MS ?? 4000,
);

export const NUTZAP_HTTP_TIMEOUT_MS = Number(
  import.meta.env.VITE_NUTZAP_HTTP_TIMEOUT_MS ?? 5000,
);
...
export const NUTZAP_PROFILE_KIND = Number(
  import.meta.env.VITE_NUTZAP_PROFILE_KIND ?? 10019,
);

export const NUTZAP_TIERS_KIND = Number(
  import.meta.env.VITE_NUTZAP_TIERS_KIND ?? 30019,
);
