...
export const messages = {
  ...
  OnboardingTour: {
    ...
    navFindCreators: "ค้นหาผู้สร้างและเริ่มสนับสนุนได้ง่าย ๆ",
    navSubscriptions: "จัดการผู้ที่คุณสนับสนุนและปรับระดับเงินได้ตลอดเวลา",
    navSettings:
      "อัปเดตการตั้งค่า การแจ้งเตือน และความปลอดภัย ทบทวนบทเรียนได้ที่นี่",
    skip: "ข้ามทัวร์",
    gotIt: "เข้าใจแล้ว",
    next: "ถัดไป",
  },
