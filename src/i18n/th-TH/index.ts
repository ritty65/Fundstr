...
export const messages = {
  ...
  OnboardingTour: {
    navToggle:
      "แตะ ☰ (สลับเมนูมุมซ้ายบน) เพื่อเปิดแถบด้านข้าง คุณสามารถเริ่มทัวร์นี้ใหม่ได้ที่การตั้งค่า",
    navDashboard: "เลือกแดชบอร์ดเพื่อดูยอดคงเหลือและกิจกรรม",
    navWallet: "เลือกกระเป๋าเงินเพื่อจัดการการฝากและถอน",
    navFindCreators: "เลือกค้นหาครีเอเตอร์เพื่อค้นหาคนที่ต้องการสนับสนุน",
