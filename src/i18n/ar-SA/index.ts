...
export const messages = {
  ...
  OnboardingTour: {
    ...
    navWallet: "أودع أو اسحب الأموال وراجع معاملاتك هنا.",
    navFindCreators: "اكتشف المبدعين وابدأ دعمهم بسهولة.",
    navSubscriptions: "أدر من تدعم وعدّل المساهمات في أي وقت.",
    navSettings: "حدّث التفضيلات والإشعارات والأمان. أعد الجولة هنا.",
    skip: "تجاوز الجولة",
    gotIt: "فهمت",
    next: "التالي",
  },
