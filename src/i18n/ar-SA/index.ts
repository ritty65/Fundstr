...
export const messages = {
  ...
  OnboardingTour: {
    navToggle:
      "انقر على ☰ (تبديل التنقل أعلى اليسار) لفتح الشريط الجانبي. يمكنك إعادة تشغيل هذه الجولة من الإعدادات.",
    navDashboard: "اختر لوحة التحكم لعرض الأرصدة والنشاط.",
    navWallet: "اختر المحفظة لإدارة الإيداعات والسحوبات.",
    navFindCreators: "اختر البحث عن منشئين لاكتشاف من تدعم.",
