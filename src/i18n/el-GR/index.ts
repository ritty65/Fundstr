...
export const messages = {
  ...
  OnboardingTour: {
    navToggle:
      "Κάνε κλικ στο ☰ (εναλλαγή πλοήγησης επάνω αριστερά) για να ανοίξεις την πλευρική μπάρα. Μπορείς να ξαναξεκινήσεις αυτή την περιήγηση από τις Ρυθμίσεις.",
    navDashboard:
      "Επίλεξε Πίνακας ελέγχου για να δεις υπόλοιπα και δραστηριότητα.",
    navWallet: "Επίλεξε Πορτοφόλι για να διαχειριστείς καταθέσεις και αναλήψεις.",
    navFindCreators:
      "Επίλεξε Βρες δημιουργούς για να ανακαλύψεις ποιον θα υποστηρίξεις.",
    navSubscriptions:
      "Επίλεξε Συνδρομές για να διαχειριστείς ποιον υποστηρίζεις.",
    navSettings:
      "Επίλεξε Ρυθμίσεις (εικονίδιο γραναζιού) για να αλλάξεις προτιμήσεις και να ξαναξεκινήσεις αυτή την περιήγηση.",
    step: 'Step {current} of {total}',
    skip: "Παράλειψη περιήγησης",
    gotIt: "Το κατάλαβα",
    next: "Συνέχεια",
  },
};
