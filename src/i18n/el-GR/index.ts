...
export const messages = {
  ...
  OnboardingTour: {
    ...
    navDashboard:
      "Η επισκόπησή σου: υπόλοιπα, πρόσφατη δραστηριότητα και γρήγοροι σύνδεσμοι.",
    navWallet: "Κατάθεσε ή τράβηξε χρήματα και δες εδώ τις συναλλαγές σου.",
    navFindCreators:
      "Ανακάλυψε δημιουργούς και ξεκίνα να τους στηρίζεις με λίγα πατήματα.",
    navSubscriptions:
      "Διαχειρίσου ποιον στηρίζεις και άλλαξε ποσά όποτε θέλεις.",
    navSettings:
      "Ενημέρωσε προτιμήσεις, ειδοποιήσεις και ασφάλεια. Επανέλαβε εδώ το σεμινάριο.",
