...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      "test/vitest/__tests__/phonebookEnrichment.spec.ts",
      "test/vitest/__tests__/MyProfilePage.phonebook.spec.ts",
      ...
      "test/vitest/__tests__/FundstrSupportersPage.spec.ts",
      ...
      "test/vitest/__tests__/networkMessaging.spec.ts",
      ...
      "test/vitest/__tests__/relayClient.spec.ts",
      ...
      "test/chat-message-bubble.sanitize.spec.ts",
      "test/utils/core-helpers.spec.ts",
      "test/utils/app-helpers.spec.ts",
      "test/utils/wallet-helpers.spec.ts",
      "test/utils/paymentCapabilities.spec.ts",
      "test/utils/profileUrl.spec.ts",
